...
_USRLOGINREQ = _descriptor.Descriptor(
  name='UsrLoginReq',
  full_name='tutorial.UsrLoginReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='account', full_name='tutorial.UsrLoginReq.account', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pwd', full_name='tutorial.UsrLoginReq.pwd', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ip_address', full_name='tutorial.UsrLoginReq.ip_address', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_time_stamp', full_name='tutorial.UsrLoginReq.start_time_stamp', index=3,
...
UsrLoginReq = _reflection.GeneratedProtocolMessageType('UsrLoginReq', (_message.Message,), {
  ...
  '__module__' : 'addressbook_pb2'
  # @@protoc_insertion_point(class_scope:tutorial.UsrLoginReq)
  })
